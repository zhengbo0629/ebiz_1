 ...
 */
@WebServlet("/UpdateCheckTasksServlet")
public class UpdateCheckTasksServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public UpdateCheckTasksServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String uIDsString = (String) request.getParameter("packagesUID2");
		String status = (String) request.getParameter("packageStatus");
