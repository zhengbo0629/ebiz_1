	...
	<div id="wrapper">
		<div
			...
			<div style="width: 100%; overflow: auto;">
				...
				<%
					...
					List<EbizPackage> shippedPackages = EbizSql.getInstance().readPackagesForUser(offset, pagesize, user,
							EbizPackageStatusEnum.EmailedLabel.getColumnName());
				%>
				<table>
					<col width=5%>
					<col width=40%>
			...
			<div style="text-align: right; margin-right: 0px">
				<br>
				<h4>
					<a href='packingPac.jsp?PageNumber=<%=prevpage%>'>PrevPage</a><a>
					</a><a href='packingPac.jsp?PageNumber=<%=nextpage%>'>NextPage</a>
				</h4>
			</div>
