...
<body>
	...
	<div align="center">
		...
		<form name="registrationSendForm" method="post"
			action="DoctorRegistrationServlet" id="registrationSendForm"
			onsubmit="return checkUserNameprocess();">
				...
				<div
					...
					<div style="padding-left: 60px;">
						<table class="tablewithoutline">
							<tr>
								<td class="labelAlignRight">登录名：</td>
								<td><input name="username" type="text" id="username"
									required style="width: 300px; height: 24px;" /></td>
							</tr>
							<tr>
								<td class="labelAlignRight">密码：</td>
								<td><input name="password" type="password" id="password"
									required style="width: 300px; height: 24px;" /></td>
							</tr>
							<tr>
								<td class="labelAlignRight">确认密码：</td>
