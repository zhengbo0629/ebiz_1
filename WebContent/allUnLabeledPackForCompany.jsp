...
<body>
	...
	<div id="wrapper">
		<%
			...
			List<EbizPackage> shippedPackages = EbizSql.getInstance().readAllNeedLabeListPackagesForCompany(offset,
		...
		<div id="wrapperContent">
			<div align="center" style="padding-bottom: 1px; padding-top: 10px;">
				<h3 style="margin-top: 5px;">所有UnLabel包裹(All UnLabeled Packages)</h3>
			</div>
			...
			<div id="threeBox">
				<div class="alignleft">
					...
					<form name="editCheckBox" id="editCheckBox"
						action="TakeLabelTasksServlet" method="post">
			...
			<div style="width: 100%; overflow: auto;">
				...
				<table
					...
					<tr>
						...
						<td><form action='TakeOneUserLabelTaskServlet' method='POST' name="oneUserTaskForm<%=row.UID%>" id="oneUserTaskForm<%=row.UID%>">
			...
			<div style="text-align: right; margin-right: 0px">
				<br>
				<h4>
					<a href='allUnLabeledPackForCompany.jsp?PageNumber=<%=prevpage%>'>PrevPage</a><a>
					</a><a href='allUnLabeledPackForCompany.jsp?PageNumber=<%=nextpage%>'>NextPage</a>
				</h4>
			</div>
		</div>
	</div>
