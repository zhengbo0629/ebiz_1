...
<body>
	<%
		...
		if (!EbizSql.getInstance().isAdministrator(user)
				&& (!user.getUserPermissions().contains(EbizUserPermissionEnum.AutoEmailDealSubscription.getName())
						|| !company.getPermissions()
								.contains(EbizUserPermissionEnum.AutoEmailDealSubscription.getName()))) {
	%>
