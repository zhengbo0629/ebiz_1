...
<body>
	...
	<div id="wrapper">
		<%
			...
			List<EbizPackage> shippedPackages = EbizSql.getInstance().readAllPaidkagesForUser(user, company,offset,
					pagesize);
		%>
		<%
		...
		<div id="wrapperContent">
			<div align="center" style="padding-bottom: 1px; padding-top: 10px;">
				<h3 style="margin-top: 5px;">所有完成的支付任务(支付All Finished Pay
					Tasks)</h3>
			</div>
			...
			<div style="width: 100%; overflow: auto;">
				...
				<table
					...
					<tr>
						...
						<td style='font-size: 12px; line-height: 15px; padding-top: 5px; padding-bottom: 5px'><%=row.getPayStatus()%>&nbsp;by:<%=row.getPayer()%>
			...
			<div style="text-align: right; margin-right: 0px">
				...
				<h4>
					<a
						href='allPaidPackForUser.jsp?PageNumber=<%=prevpage%>'>PrevPage</a><a>
					</a><a
						href='allPaidPackForUser.jsp?PageNumber=<%=nextpage%>'>NextPage</a>
				</h4>
			</div>
		</div>
	</div>
