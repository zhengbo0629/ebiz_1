...
<body>
	<form name="registrationSendForm" method="post"
		action="NurseRegistrationServlet" id="registrationSendForm" onsubmit="return checkUserNameprocess();">
				...
				<div
					...
					<div style="padding-left: 60px;">
						<table class="tablewithoutline">
							...
							<tr>
								<td class="labelRightAlign">个人邮箱：</td>
							...
							<tr>
								...
								<td><input name="companyName" type="text" id="companyName"
									value="Micro" required style="width: 300px; height: 24px;" /></td>
							</tr>
						</table>
					</div>
					<div style="height: 10px; width: 100%; clear: both; float: left;">
