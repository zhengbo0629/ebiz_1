...
<body>
	...
	<div id="wrapper">
		<div
			...
			<div style="width: 100%; overflow: auto;">
				...
				<table style="table-layout:fixed;word-wrap: break-word;font-size: 11px">
					...
					<tr>
						...
						<td><%=row.balance%></td>
						<td><form action="DeleteUserServlet" method="POST" name="deleteForm<%=row.UID%>" id="deleteForm<%=row.UID%>">
						<input type="hidden" name="userID" value="<%=row.UID%>" /><input
									type="button" style="width: 50px; height:35px; font-size: 13px"
									name="submit-btn" value="Delete" onclick="deleteUser(this)" />
							</form></td>
			...
			<div style="text-align: right; margin-right: 0px">
				<br>
				<h4>
					<a href='deleteUser.jsp?PageNumber=<%=prevpage%>'>PrevPage</a><a>
					</a><a href='deleteUser.jsp?PageNumber=<%=nextpage%>'>NextPage</a>
				</h4>
			</div>
	...
	<script type="text/javascript">
	function deleteUser(source){
		 var msg = "Are you sure want to delete this user？\n\n Please confirm！"; 
