	...
	<div id="wrapper">
		<div
			...
			<div align="center" style="padding-bottom: 1px; padding-top: 10px;">
				<h3>ÓÊ¼ÄÍê³É°ü¹ü(Ship Complete Package)</h3>
			</div>
			<div style="width: 100%; overflow: auto;">
				...
				<%
					...
					List<EbizPackage> shippedPackages = EbizSql.getInstance().readPackagesForUser(offset, pagesize, user,
							EbizPackageStatusEnum.Complete.getColumnName());
				%>
				<table>
					<col width=5%>
					<col width=35%>
					...
					<tr>
						...
						<td style='font-size: 10px;line-height: 12px;'><%=row.creditcardNumber%></td>
			...
			<div style="text-align: right; margin-right: 0px">
				<br>
				<h4>
					<a href='shipCompletePac.jsp?PageNumber=<%=prevpage%>'>PrevPage</a><a>
					</a><a href='shipCompletePac.jsp?PageNumber=<%=nextpage%>'>NextPage</a>
				</h4>
			</div>
