...
<body>
	...
	<div id="wrapper">
		<%
			...
			List<EbizPackage> shippedPackages = EbizSql.getInstance().readAllNeedCheckPackagesForCompany(offset,
		...
		<div id="wrapperContent">
			<div align="center" style="padding-bottom: 1px; padding-top: 10px;">
				<h3 style="margin-top: 5px;">所有未对单包裹(All UnCheck Packages)</h3>
			</div>
			...
			<div id="threeBox">
				<div class="alignleft">
					...
					<form name="editCheckBox" id="editCheckBox"
						action="TakeCheckTasksServlet" method="post">
			...
			<div style="width: 100%; overflow: auto;">
				...
				<table
					...
					<tr>
						...
						<td><form action='TakeOneCheckTaskServlet' method='POST' name="oneTaskForm<%=row.UID%>" id="oneTaskForm<%=row.UID%>">
								<input type='hidden' name='packageid' id='packageid' value="<%=row.UID%>" /> <input
									onclick="takeOneTask(this)" type="button" value="领取任务"
									name="updateOne"
			...
			<div style="text-align: right; margin-right: 0px">
				<br>
				<h4>
					<a href='allUnCheckedPackForCompany.jsp?PageNumber=<%=prevpage%>'>PrevPage</a><a>
					</a><a href='allUnCheckedPackForCompany.jsp?PageNumber=<%=nextpage%>'>NextPage</a>
				</h4>
			</div>
		</div>
	</div>
