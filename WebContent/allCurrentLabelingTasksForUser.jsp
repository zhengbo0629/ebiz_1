	...
	<div id="wrapper">
		...
		<div id="wrapperContent">
			<div align="center" style="padding-bottom: 1px; padding-top: 10px;">
				<h3 style="margin-top: 5px;">所有领取的Lable任务(All Taken Labeling
					Tasks)</h3>
			</div>
			...
			<div id="threeBox">
				...
				<div class="aligncenter">
					...
					<input onclick="labelGroupTasks()" type="button" value="批量发送label"
						name="updateAll"
						style="margin-top: 10px; width: 90px; font-size: 12px; height: 30px; background-color: #ffcebf">
				...
				<table
					...
					<tr>
						...
						action="" method='POST'>
									...
									onclick="labelOneTask(this)" type="button" value="发送label"
									name="updateOne"
